/*
 *  SQL para inclusão de países e nações (c/ Código do Portal do Comércio Exterior ou BACEN) + Estados e Federações Brasileiras (c/ DDD e Código do IBGE) + Cidades e Municípios Brasileiros (c/ Código do IBGE).
...
INSERT INTO `countries` (`id`, `name`, `name_pt`, `country_abbreviation`, `bacen`) VALUES
...
INSERT INTO `states` (`id`, `name`, `state_abbreviation`, `ibge`, `country_id`, `ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
ALTER TABLE `addresses` 
  ADD CONSTRAINT `fk_address_state`  foreign key (`state_id`) references `states`(`id`);
