package net.diegoqueres.backendqualification.security;

import static net.diegoqueres.backendqualification.constants.SecurityConstants.EXPIRATION_TIME;
import static net.diegoqueres.backendqualification.constants.SecurityConstants.KEY;
